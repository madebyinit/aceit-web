...
class ControlController {
    ...
    _physicalBind(){
        // if(_.get(this.user,'imagery')) {
            ...
            this._useSelectedPhysicalTool('three');
        // }
    }
    ...
    _concentrationPhysicalBind(){
        ...
        if(_.get(this.user,'concentration') || imagery){
        ...
        this._useSelectedPhysicalTool('two');
    }
    ...
    _useSelectedPhysicalTool(stepNumber) {
        ...
        if (tool) {
            switch (tool) {
                case 'Neck & Shoulders':
                    this.steps[stepNumber] = 'Rotate Neck & Shoulders';
                    break;
                case 'Breathing':
                    this.steps[stepNumber] = 'Take a deep breath';
                    break;
                case 'Imagery':
                    if (!imagery) {
