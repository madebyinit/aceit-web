        ...
        if (this.seconds === 0) {
          ...
          switch (this.gameNumber) {
            ...
            case 2:
              ...
              // this.gamesService.getGameResult(this.orderOfGames.gameSequence[this.gameNumber - 1], this.secondsleft, duration, noOfMoves, instructionsClickCount, win, firstMoveTime);
